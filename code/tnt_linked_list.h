...
#define linked_list_iterator_head(l, t, d) ((LinkedList_Iterator){l.head, offsetof(t, d)})
#define linked_list_iterator_tail(l, t, d) ((LinkedList_Iterator){l.tail, offsetof(t, d)})
